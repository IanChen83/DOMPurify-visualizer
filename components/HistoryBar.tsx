...
import { Trash2, Plus, Clock, Edit2, X, ChevronUp, ChevronDown } from 'lucide-react';
...
export const HistoryBar: React.FC<HistoryBarProps> = ({
  ...
  return (
    <div className={clsx("border-t border-gray-700 bg-gray-900 flex flex-col transition-all", isOpen ? "h-48" : "h-10")}>
      {/* Toolbar */}
      <div className="h-10 border-b border-gray-800 bg-gray-900 flex items-center px-4 justify-between shrink-0">
        <button 
          onClick={() => setIsOpen(!isOpen)}
          className="flex items-center gap-2 hover:bg-gray-800 px-2 py-1 -ml-2 rounded transition-colors"
        >
